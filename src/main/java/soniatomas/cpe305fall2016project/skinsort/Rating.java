 ...
 * contains Rating of the user, rating determined by the system, and maintains
 * the name of the products/ingredients that help determine the rating. This
 * class does not do any calculations or logic to determine the system rating of
 * the ingredient or product, it only holds the rating values and returns them
 * when called. System rating determined by RatingLogic Class
 * 
 * @author Sonia
 *
 */
...
public class Rating {
  ...
  // If this rating object is for an Ingredient, then references contains the
  // names
  // of the products that affect the rating of the Ingredient.
  // If this rating object is for a Product, then references contains the names
  // of
  ...
  /**
   * Sets User rating, the rating inputted by the user. Rating ranges from 0 to
   * 10
   * 
   * @param newRating
  ...
  /**
   * Sets system rating, the rating calculated/determined by the system. Rating
   * ranges from 0 to 10
   * 
   * @param newRating
   *          - value of the new rating
  ...
  /**
   * Add the name of reference products or ingredients that help the system
   * determine the rating for the product or ingredient. If this rating object
   * belongs to an Ingredient, then references will contain the names of the
   * Products that affect the rating of the Ingredient. If this rating object
   * belongs to a Product, then references contains the name of the Ingredients
   ...
   * 
   * @param reference
   *          - the name of the reference Ingredient or Product to remove
   * @return true if the name of the reference Ingredient or Product has been
